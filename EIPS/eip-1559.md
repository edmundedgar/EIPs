...
class World(ABC):
	def validate_block(self, block: Block) -> None:
        ...
        fee_pool_payment = self.account(0x1559).balance / 10000
        self.account(0x1559).balance -= fee_pool_payment
        self.account(block.author).balance += fee_pool_payment
        ...
        self.account(0x1559).balance += block.gas_used * block.base_fee_per_gas
